package com.example.stephaniemoriarty.myfirstproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void getfactfornumber(final float number) {
/**
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url+numberValue,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(MainActivity.this, "Check out this fun fact !" + response, Toast.LENGTH_LONG).show();
